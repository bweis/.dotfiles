setup_osx() {
	...
	# THIS MAY FAIL
	# System Preferences > Privacy & Security > Full Disk Access > turn on your terminal apps (iTerm2, wezterm, etc.)
	# and the default command works on the `com.apple.Safari` namespace!
